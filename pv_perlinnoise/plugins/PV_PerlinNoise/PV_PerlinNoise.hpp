...
class PV_PerlinNoise : public SCUnit {
public:
    PV_PerlinNoise();
...
private:
    ...
    double perlin2D(double x, double y, int octaves, double persistence);
    ...
    double mMagScale = 1.0;
    double mStepScale = 0.01;
    int mOctave = 1;
