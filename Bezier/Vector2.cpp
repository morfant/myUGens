...
std::vector<Vector2> Vector2::identityMatrix()
{
	Vector2 idX{ 1,0 };
	Vector2 idY{ 0,1 };

    std::vector <Vector2> identity{ idX, idY };
...
{
    std::cout << "(" << this->mag << ", " << this->dir << "rad)" << std::endl;
...
// Vector2 objects
void Vector2::printMatrix(std::vector <Vector2> matrix)
{
